...
import 'package:flooter/widgets/desc_container.dart';
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            //     height * 0.05,
            //     width * 0.95),
            DescripContainer(currentUser: currentUser),
            Padding(
...
showLoaderDialog1(
  ...
  AlertDialog alert = AlertDialog(
    ...
    backgroundColor: Color.fromARGB(0, 255, 255, 255).withOpacity(0.85),
    content: SizedBox(
      height: 300,
      child: Center(
        child: Column(
          children: [
            CircleAvatar(
              backgroundColor:
                  Color.fromARGB(255, 231, 230, 231).withOpacity(0.2),
              radius: 40.0,
